...
exports.ensureAdmin = function (req, res, next) {
  ...
  console.log(decodeURI(req.headers.cookie).split('globals')[1]);
  ...
  if (req.headers.authorization == undefined) {
    try {
      var tkn = JSON.parse(decodeURI(req.headers.cookie).split('globals')[1].split('=')[1].split(';')[0]).currentUser.token;
