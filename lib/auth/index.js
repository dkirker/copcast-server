...
exports.ensureAdmin = function (req, res, next) {
  ...
  console.log(unescape(req.headers.cookie).split('globals')[1]);
  ...
  if (req.headers.authorization == undefined) {
    try {
      var tkn = JSON.parse(unescape(req.headers.cookie).split('globals')[1].split('=')[1].split(';')[0]).currentUser.token;
