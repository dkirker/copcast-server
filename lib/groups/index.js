...
app.get('/groups/:id/locations/:date/:accuracy', auth.ensureAdminLevelOne, function(req, res){
...
app.get('/groups/:id/locations/:initialDate/:finalDate/:accuracy', auth.ensureAdminLevelOne, function(req, res){
