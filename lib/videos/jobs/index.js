...
var periodOfRetention = config.periodOfRetention || 90;
...
function deleteOldVideos(){
  ...
  db.video.findAll({where: {date: { $lte: dateLimit.toDate()}, $or: [{ isDeleted: false}, {isDeleted: null}],
    $or: [{ hasIncident: false}, {hasIncident: null}]}}).then(function(videos){
