    ...
    callback('e1'+err);
  }).addOption('-vcodec', 'libx264').videoFilters([
      {
        ...
        options: {
          ...
          fontsize: 20, fontcolor: 'white', boxcolor: 'black',  fix_bounds: '1', box: '1', y: '12'
        }
      },{
        filter: 'drawtext', options: {
          fontfile: fontsPath, text:  ' Exported by ' + user.name ,
          fontsize: 20, fontcolor: 'white', boxcolor: 'black', fix_bounds: '1', box: '1', y: '24'
        }
      },{
        filter: 'drawtext', options: {
          fontfile: fontsPath, text: ' At ' +
          moment(video.date).format('YYYY/MM/DD HH_mm'),
          fontsize: 20, fontcolor: 'white', boxcolor: 'black', fix_bounds: '1', box: '1', y: '36'
        }
      }])
    .save(filename);
}
