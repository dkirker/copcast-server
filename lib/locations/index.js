...
app.post('/locations/:user', auth.ensureUser, function (req, res) {
...
app.get('/users/:id/locations/:initialDate/:finalDate/:accuracy', auth.ensureAdminLevelOne, function(req,res) {
...
app.get('/users/:id/locations/:date/:accuracy', auth.ensureAdminLevelOne, function(req,res) {
  var dateRange = [moment(req.params.date).toDate(), moment(req.params.date).hour(23).minute(59).seconds(59).toDate()];
