var request = require('supertest'),
  ...
  db = require('./../../lib/db'),
  rest = proxyquire('./../../lib/incidentForms', {'./../auth': auth, './../db': db}),
...
describe('Bulk incidentForms upload', function() {
  ...
  describe('Bulk uploads',function(){
    it('will upload one item', function (done) {
      request(app).post('/incidentForms/testuser')
  ...
  describe('Individual uploads',function(){
    it('sends valid incident request',function(done) {
      request(app).post('/incidentForms')
